...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="banner">STAY HIGH PRIVATE LIMITED</div>
      <div class="menu">
      ...
      <div class="content">
        <div class="homecontent">
          <h1>WELCOME TO STAY HIGH!!!</h1>
          <div class="contenttext"></div>
          <h1>About Us</h1>
          <img src="./img/build.jpg" alt="STORE" />
          <div class="contenttext">
           AT STAY WE ARE PROVIDING TOP COLLECTIONS OF THE ALBUMS,PRODUCTS 
           ...
           TO RECEIVE YOUR WONDERFUL COMMENTS. 
            ...
            WHY YOU HAVE TO CHOOSE OUR PRODUCTS?<br/>
            <ol=I>
              <li>MANY OFFERS FOR SUBSCRIPTION</li>
              <li>UPDATES OF THE PURCHASED PRODUCTS</li>
              <li>EASY TO RETURN OR TURN OUT SUBSCRIPTION</li>
            </ol>
            THANKYOU AND ENJOY YOUR PRODUCT!!!<br/>
          </div>
        </div>
      </div>
      <div class="footer">
        Copyright &#169; 2021 STAY HIGH PRIVATE LIMITED, Developed by G.Pavithra.
      </div>
    </div>
  </body>
</html>
...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="productcontent">
          ...
          <div class="productitems">
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i1.jpg" alt="product 1">
              </div>
              <div class="itemname">Software Giant</div>
              <div class="itemprice">Price: Rs.1,244.00</div>
            </div>
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i2.jpeg" alt="product 2">
              </div>
            ...
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i3.png" alt="product 3">
              </div>
              <div class="itemname">Security x60</div>
              <div class="itemprice">Price: Rs.3,542</div>
            </div>
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i4.jpg" alt="product 4">
              </div>
              <div class="itemname">Meg anti-virus</div>
              <div class="itemprice">Price: Rs.999.00</div>
          </div>
          <div class="productitem">
            <div class="itemimage">
            <img src="./img/i5.jpg" alt="product 5">
            </div>
            <div class="itemname">Maze 360</div>
            <div class="itemprice">Price: Rs.2,499</div>
          </div>
          <div class="productitem">
            <div class="itemimage">
            <img src="./img/i6.jpg" alt="product 6">
            </div>
            <div class="itemname">Base javascript</div>
            <div class="itemprice">Price: Rs.3,999.00</div>
          </div>
          <div class="productitem">
              <div class="itemimage">
              <img src="./img/i7.jpg" alt="product 7">
              </div>
              <div class="itemname">Mail head</div>
              <div class="itemprice">Price: Rs.584.00</div>
            </div>
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i8.png" alt="product 8">
              </div>
              <div class="itemname">Zipper b30</div>
              <div class="itemprice">Price: Rs.949.00</div>
            </div>
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i9.jpg" alt="product 9">
              </div>
              <div class="itemname">Kar take-01</div>
              <div class="itemprice">Price: Rs.895.00</div>
            </div>
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i10.jpg" alt="product 10">
              </div>
              <div class="itemname">Jezz x07</div>
              <div class="itemprice">Price: Rs.779.00</div>
            </div>
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i11.png" alt="product 11">
              </div>
              <div class="itemname">Mart os1</div>
              <div class="itemprice">Price: Rs.149.00</div>
            </div>
            <div class="productitem">
              <div class="itemimage">
              <img src="./img/i12.jpg" alt="product 12">
              </div>
              <div class="itemname">Mart os2</div>
              <div class="itemprice">Price: Rs.149.00</div>
            </div>
          </div>
        </div>
      ...
      <div class="footer">
        Copyright &#169;2021 STAYHIGH PRIVATE LIMITED, Developed by G.Pavithra.
      </div>
    </div>
  </body>
</html>
...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="banner">STAY HIGH</div>
      <div class="menu">
        <div class="menuitem"><a href="/static/home.html">Home</a></div>
        <div class="menuitem"><a href="/static/products.html">Products</a></div>
        <div class="menuitem"><a href="/static/people.html">People</a></div>
      ...
      <div class="content">
        <div class="homecontent">
          ...
          <h1>Contact us:</h1>
          <div class="contenttext">
           ADDRESS:STAYHIGH PRIVATE LIMITED PLAZZA,1134 S Montreal Ave,
           Dallas, TX 75208 
        
            <br />
            CONTACT EMAIL:stayhigh_contactus@gmai.com <br />
            Enjoy our product.<br/>
            Keep smiling.<br/>
            Support and share our products.<br/>
            THANKYOU AND ENJOY YOUR PRODUCTS WITH REGULAR UPDATES!!!<br/>
          </div>
        </div>
      </div>
      <div class="footer">
